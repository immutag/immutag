...
oneTimeSetUp() {
    ...
    mv tag_replace_test.sh immutag/
...
testEquality() {
    ...
    result_test=$(eval ls immutag/tag_replace_test.sh)
    result_test2=$(eval ls immutag/add_tag_test.sh)
    assertEquals "foo" "$result_foo"
    assertEquals "bar" "$result_bar"
    assertEquals "immutag/tag_replace_test.sh" "$result_test"
    assertEquals "immutag/add_tag_test.sh" "$result_test2"
}

...
testEquality() {
    ...
    imt add --store-name "$name" --no-default-name foo.txt tag1 tag2 tag3
    ...
    imt add --store-name "$name" --no-default-name bar.txt tag1 tag2 tag3
    ...
    ## Rollforward
    imt rollforward --store-name "$name"
    ...
    imt add --no-default-name --store-name "$name" foofoo.txt tag
    ...
    imt replace-tags --store-name "$name" 1CaKbES6YZY2rm2grufw8gw1URafLdJN8Q a b c d e f g

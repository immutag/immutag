...
# Setup the test.
sudo docker exec immutag_environment_1 /bin/sh -c 'cd /root/immutag_test && ./init_setup_test.sh'

# Run the target test.
sudo docker exec immutag_environment_1 /bin/sh -c 'cd /root/immutag_test && ./init_test.sh'
